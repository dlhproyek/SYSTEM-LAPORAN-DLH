          ...
          <table className="w-full min-w-[1200px] border-collapse border-2 border-black text-[11px] table-fixed">
            <thead className="pdf-table-header">
              <tr style={{ height: '40px' }}>
                ...
                <th style={headerStyle} className="border-2 border-black p-2 w-[65px]" rowSpan={2}><div className="flex items-center justify-center h-full">Hari / Tgl</div></th>
                <th style={headerStyle} className="border-2 border-black p-2 w-[75px]" rowSpan={2}><div className="flex items-center justify-center h-full">Tim/ Kecamatan</div></th>
              ...
              <tr style={{ height: '30px' }}>
                <th style={subHeaderStyle} className="border-2 border-black p-1 w-[120px]">0%</th>
                <th style={subHeaderStyle} className="border-2 border-black p-1 w-[120px]">50%</th>
                <th style={subHeaderStyle} className="border-2 border-black p-1 w-[120px]">100%</th>
