        ...
        {isSpjBbm && !isAdmin ? (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold flex items-center gap-2"><Fuel className="text-blue-600" /> Manajemen SPJ BBM</h2>
              {isLoggedIn && (
                <Button onClick={() => navigate('/fuel-spj/create')} className="bg-blue-600 hover:bg-blue-700 h-10 font-bold shadow-sm">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <TabsList className={cn(
                ...
                isAdmin ? "w-[600px] grid-cols-3" : "w-[400px] grid-cols-2"
              )}>
                ...
                {isAdmin && <TabsTrigger value="fuel_spj" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white flex items-center gap-2"><Fuel size={16} /> Manajemen SPJ BBM</TabsTrigger>}
              </TabsList>
              {isLoggedIn && (
